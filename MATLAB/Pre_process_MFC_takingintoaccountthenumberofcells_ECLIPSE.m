function [S_scaled, pre_process_modes] = Pre_process_MFC_takingintoaccountthenumberofcells_ECLIPSE(S, paired_data, pre_process_modes)
...
%% Written by R. Folcarelli for the ECLIPSE model
%% extract information
...
elseif auto_mode == 2
    std_control = mean_of_standard_deviation(S_scaled(logical((Labels == 1).*trainset)));
    for l1 = 1:length(S_scaled)
