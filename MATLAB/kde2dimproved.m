function [bandwidth,density,X,Y, MIN_XY,MAX_XY,bins]=kde2dimproved(data,n,MIN_XY,MAX_XY)
...
%
%  Modified by:
%  Roel Bouman (Roelbouman@gmail.com) and Rita Folcarelli (r.folcarelli@science.ru.nl)
%  Date: 12-05-2016
%  Added exportation of the bin indices corresponding to the data in "data"
%  Date: 25-05-2016
%  Improved readability of the code
%  Removed global variables
%  Removed nested functions
%  Improved code by replacing dummy variables with ~'s
%  Improved code by making use of 1i instead of i for complex numbers
...
[initial_data,bins]=ndhist(transformed_data,n);
