...
% Modified version which take in account the number of cells written by R.
% Folcarelli and G.H. Tinnevelt at Radboud University Nijmegen

%% Dependencies
% flow_arcsinh
% unpaired_centering_numcells
% paired_centering
% mean_of_standard_deviation
